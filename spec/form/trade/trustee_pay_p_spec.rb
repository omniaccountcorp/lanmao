...
RSpec.describe '受托支付申请' do
  ...
  it "成功申请" do
    result = client.trustee_pay_p( Lanmao::Utils.gen_flow_id, card_no, 40, 12, cert_no, card_no, "", 'http://test.omniaccount.com', 'http://test.omniaccount.com', 'http://test.omniaccount.com')
