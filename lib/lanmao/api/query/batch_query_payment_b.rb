  ...
  module Api
    module Query
      module BatchQueryPaymentB
        ...
        #
        def batch_query_payment_b(batch_no, batch_count, batch_type,
                                  batch_date, items,
                                  devise='000001', remark='')

          service = 'batch_query_payment_b'
          ...
          res = operate_post(:query, service, params, Http::ErrorCode.batch_query_payment_b, ['RD000000'])
